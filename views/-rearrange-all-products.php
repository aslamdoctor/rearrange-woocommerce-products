...
<div class="notice notice-warning inline top-notice">
    <ul>
        ...
        <li>-
            <?php esc_html_e('Use "single click" to select multiple products and drag them.', 'rearrange-woocommerce-products'); // phpcs:ignore ?>
        </li>
        ...
        <li>- <?php esc_html_e('Products arranged below', 'rearrange-woocommerce-products'); ?>
            ...
            <?php esc_html_e('after deactivating or deleting the plugin.', 'rearrange-woocommerce-products'); // phpcs:ignore ?>
        </li>
        <?php
}
else {
...
?>
        ...
        <li>- <?php esc_html_e('If you are facing any issues, try the ', 'rearrange-woocommerce-products'); ?><a
            ...
            <?php esc_html_e('steps first.', 'rearrange-woocommerce-products'); // phpcs:ignore ?></li>
    </ul>
</div>
...
<input type="button" value="Sort By Price" id="rwpp-sort-by-price">
