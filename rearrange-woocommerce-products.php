...
if (!class_exists('ReWooProducts')) {
	...
	class ReWooProducts
	{
		...
		public function enqueue_assets($hook)
		{
			...
			wp_register_script(
				'rwpp_js',
				(RWPP_LOCATION_URL . '/dist/js/main.js'),
		...
		{
?> <div class="error">
    <p> <?php esc_html_e('Please activate Woocommerce plugin before using', 'rearrange-woocommerce-products'); ?>
        <strong><?php esc_html_e('Rearrange Woocommerce Products', 'rearrange-woocommerce-products'); ?></strong>
        <?php esc_html_e('plugin', 'rearrange-woocommerce-products'); ?>.
    </p>
</div>
<?php
		}
